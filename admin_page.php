...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="sidebar" id="sidebar">
            <ul>
                ...
                <li>
                    <a href="#" id="add" class="btn">
                        <span class="title">Home</span>
                    </a>
                </li>
                <li>
                    <a href="#" id="show" class="btn">
                        <span class="title">Approve Request</span>
                    </a>
                </li>
                <li>
                    <a href="#" id="interested" class="btn">
                        <span class="title">Interested Property</span>
                    </a>
                </li>
                <li>
                    <a href="#" id="booked" class="btn">
                        <span class="title">Booked Property</span>
                    </a>
                </li>
        ...
        <div class="part_interested" style="margin-top: 9rem; justify-content: center">
        <div class="col d-flex justify-content-center">
            ...
            <div class="col">
                <table class="table table-hover">
                    ...
                    <tbody>
                        <?php foreach ($interseted_property_info_admin as $i => $property) : ?>
                            <tr>
                                <td><?php echo $property['p_details_id'] ?></td>
                                <td><?php echo $property['username'] ?></td>
                                <td><?php echo $property['contact_no'] ?></td>
                                <td><?php echo $property['name'] ?></td>
                                <td><?php echo $property['contact'] ?></td>
                                <td><?php echo $property['house_no'] ?></td>
                                <td><?php echo $property['area'] ?></td>
                                <td><?php echo $property['thana'] ?></td>
                                <td><?php echo $property['floor'] ?></td>
                                <td><?php echo $property['room'] ?></td>
        ...
        <div class="part_booked" style="margin-top: 9rem; justify-content: center">
        <div class="col d-flex justify-content-center">
            ...
            <div class="col">
                <table class="table table-hover">
                    ...
                    <tbody>
                        <?php foreach ($booked_property_info_admin as $i => $property) : ?>
                            <tr>
    ...
    <script type="text/javascript">
        document.getElementById('add').addEventListener("click", function() {
            ...
            document.querySelector('.part_interested').style.display = "none";
            document.querySelector('.part_booked').style.display = "none";
        ...
        document.getElementById('interested').addEventListener("click", function() {
            ...
            document.querySelector('.part_3').style.display = "none";
            document.querySelector('.part_booked').style.display = "none";
            document.querySelector('.part_interested').style.display = "grid";
        ...
        document.getElementById('booked').addEventListener("click", function() {
            ...
            document.querySelector('.part_2').style.display = "none";
            document.querySelector('.part_3').style.display = "none";
            document.querySelector('.part_booked').style.display = "grid";
            document.querySelector('.part_interested').style.display = "none";
